...
# Question 3
```{r, eval = F}
Texevier::create_template_html(directory = "/Users/mac/Desktop/Masters/21777039/Question 3/",
                          template_name = "htmlQuestion3",
                          build_project = T, open_project = F)
```
...
# Source in all your functions:
list.files('Question 3/htmlQuestion3/code/', full.names = T, recursive = T) %>% as.list() %>% walk(~source(.))
