...
title: "Data Science 871 Mock Practical Question 1"
...
keywords: "Data Science \\sep Economics \\sep Netflix" # Use \\sep to separate
...
```{r}
library(readr)
CreditsData <- read_csv("data/credits.csv")
TitlesData <- read_csv("data/titles.csv")
...
Having more seasons does not mean there is a higher score. 
...
Movies has become less popular. Series has become more. Load more series. 
